...
const int DOSSIER_BACK = 22;
const int DOSSIER_FORWARD = 24;

const int HAUTEUR_BACK = 26;
const int HAUTEUR_FORWARD = 28;

const int AVANCEMENT_BACK = 30;
const int AVANCEMENT_FORWARD = 32;

const int ASSISE_BACK = 34;
const int ASSISE_FORWARD = 36;
